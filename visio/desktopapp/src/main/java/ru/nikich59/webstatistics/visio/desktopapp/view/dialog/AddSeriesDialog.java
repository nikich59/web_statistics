...
import ru.nikich59.webstatistics.visio.desktopapp.view.editview.DiffSeriesEditView;
import ru.nikich59.webstatistics.visio.desktopapp.view.editview.MultiplySeriesEditView;
import ru.nikich59.webstatistics.visio.desktopapp.view.editview.RateSeriesEditView;
import ru.nikich59.webstatistics.visio.desktopapp.view.editview.SeriesEditView;
					...
					try
					{
						switch ( choiceBox.getSelectionModel( ).getSelectedItem( ) )
						{
							...
							case "rate":
								...
								break;
							case "diff":
								seriesEditView = new DiffSeriesEditView( baseSeries );
								break;
						}
					}
